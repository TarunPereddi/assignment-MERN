...
function App() {
  const desktopview = useMediaQuery({ query: "(min-width: 790px" });
  const mobileview = useMediaQuery({ query: "(min-width: 400px" });
  const [follow, setfollow] = useState(obj1);
  ...
  const Updating_follow_grp = (clicked_group) => {
    follow.map((group, index) => {(group[1] === clicked_group) && (follow[index][2] = !group[2])})
      ...
      <div>
        ...
        <div style={{ backgroundColor: "black" }}>
          <img
            ...
            style={{
              width: 100 % App,
              height: desktopview ? "440px" : mobileview ? "300px" : "200px",
              marginTop: desktopview ? "72px" : "",
              opacity: "0.5",
            }}
          />
          <h2
              ...
              <p>
                ...
                <img
                  ...
                  style={{
                    cursor: "pointer",
                    position: "absolute",
                    marginTop: mobileview ? "-275px" : "-183px",
                    marginLeft: "3.75%",
                  }}
                />
              </p>
              {signedin ? (
                <button
                  ...
                  style={{
                    ...
                    color: "white",
                    borderRadius: "4px",
                    marginTop: mobileview ? "-298px" : "-205px",
                    right: "0",
                    marginRight: "3.75%",
                  }}
                  class="btn btn-sm"
        ...
        {desktopview && <hr className="seperator" />}
        <div className="leftsidepanel">
          <div
            style={{
              width: desktopview ? "50%" : "100%",
             
              height: desktopview ? "83vh" : "94vh",
              overflowY: "auto",
            }}
            className="example"
          >
            <div
              ...
              style={{
                width: "100%",
                boxShadow: desktopview ? "" : "0px 1px 2px rgba(0, 0, 0, 0.12)",
            ...
            >
              ...
              <div class="card-body">
                ...
                >
                  ...
                  on, I plan to reidf bsgakksa shly akssdjj shadkj
                </h6>
                <div
                  style={{ display: "flex", justifyContent: "space-between" }}
                >
          ...
          {desktopview && (
            <div className="rightsidepanel">
              ...
              <div style={{ display: !signedin && "none" }}>
                ...
                <br />
                <h6>
                  <img style={{ marginTop: "-5px" }} src={likeicon} />{" "}
                  RECOMMENDED GROUPS
                </h6>
                {follow.map((group) => (
                  <>
